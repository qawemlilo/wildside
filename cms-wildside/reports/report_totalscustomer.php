...
<table width="925" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="34%" valign="middle"><h2>Company Turnover</h2></td>
...
// Build SQL Query  
$query = "SELECT w_company.company_name, w_company.industry_category, SUM(w_orders.total)
...
echo'<th class="cellnorghtborder" style=" text-align: right;">' . ucwords(mysql_field_name($result, 2)). '</th>';
...
echo'<td class="tdborderbottom" style=" text-align: right;">R '. number_format($row[2], 2, '.',' '). '</td>';
;
