...
<div class="div960blue" style=" border:none; "><strong style="font-size:17px; color: #FEFEFE; padding-left:15px;">UPDATE ORDER</strong></div>
</div>
...
<legend>Agent</legend>
<li>
<select name="agent"  class="iselect" style="font-size:14px;"> 
...
<li>
<select name="company_id"  class="iselect" style="font-size:14px;"> 
...
<li>
<select name="agency_id"  class="iselect" style="font-size:14px;" > 
...
<li></li>
<li><label for="ci_number">CI Number</label><input class="itext"   type="text"   id="ci_number"  name="ci_number" value="<? echo $rowname['ci_number']?>"/></li>
<li></li>
</fieldset>
<li></li>

<fieldset>
<legend>Change Price if you have to?</legend>
<li></li>
<li><label for="order_price">Order Price</label><input class="itext"   type="text"   id="order_price"  name="order_price" value="<? echo $rowname['order_price']?>"/></li>
<li></li>
</fieldset>
<li></li>
<li></li>
...
echo '<li><label for=" discount percentage"> discount_percentage</label><input class="itext"   type="text"   id="discount_percentage"  name="discount_percentage" value="'.$rowname['discount_percentage']. '"/></li>'; 

echo '<li><label for="order instructions">order_instructions</label><input class="itextarea"   type="text"   id="order_instructions"  name="order_instructions" value="'.$rowname['order_instructions']. '"/></li>';

echo '<li><label for="order memo">order_memo</label><input class="itextarea"   type="text"   id="order_memo"  name="order_memo" value="'.$rowname['order_memo']. '"/></li>';
...
<li></li>
<li><label>&nbsp;</label><input class="ibutton" type="Submit" name="submit" value="Update this record" /><label></label>&nbsp;&nbsp;&nbsp;<input class="ibutton" type="cancel" name="cancel" value="Delete this record" onclick="window.location = 'deletebooking.php?id=<?php echo $id; ?>' " /></li>
...
echo '<p></br></br>Update successful.</br></br>&nbsp; <a href="bookingsdisplay.php?id='.$id.'" style="color:#FFF;">Display the record </a> </p>';
...
<a href="<?php $_SERVER ['PHP_SELF']; ?>"><i style="color:#FFF; padding-left:5px;">GO BACK TO FORM ENTRY</i></a></td></br></br
></div>
