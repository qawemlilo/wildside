...
<body>
<div class="content">
<h1 style="padding-bottom:25px;">Web Visitors</h1>
<?php
if($_SESSION['id'])
{
...
$opts['fdd']['visitor_category'] = array(
...
$opts['fdd']['visitor_activity'] = array(
  'name'     => 'Favourite Acitivity',
  'select'   => 'T',
  'maxlen'   => 300,
  'sort'     => true,
  'size'       => 100
);
$opts['fdd']['visitor_place'] = array(
