...
{
echo '<form class="form-inline" action="body_detail_form.php">
<input type="hidden" name="comp_name" value="'. ($row['title']). '">
<button type="submit" class="btn">Enter Competition</button>
</form>';
}
